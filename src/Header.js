...
export default function Header() {
  ...
  return (
    <div className="bg-hero-pattern bg-cover h-screen bg-center-center bg-no-repeat w-auto ">
      <div className="flex justify-between pt-10 items-center sticky w-full px-8">
        ...
        <div className="flex item-center justify-center cursor-pointer">
          <h3
            className="text-2xl text-white pr-10 font-lato font-normal hover:text-gray-300 xsm:text-base sm:text-lg sm:pl-4 sm:pr-4 xsm:pr-2"
            onClick={() => history.push("/")}
          >
            Home
          </h3>
          <h3
            className="text-2xl text-white font-lato font-normal hover:text-gray-300 xsm:text-base sm:text-lg  xsm:pr-2"
